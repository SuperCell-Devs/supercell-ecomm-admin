...
interface IProps {
    aspectRatio: number | "Initial" | undefined;
    setAspectRatio: React.Dispatch<React.SetStateAction<number | "Initial" | undefined>>;
    imageFileType: number | "Initial" | undefined;
    setImageFileType: React.Dispatch<React.SetStateAction<number | "Initial" | undefined>>;
    selectImagefiles: never[];
    setselectImagefiles: React.Dispatch<React.SetStateAction<never[]>>;
}

const AssetUpload = (props: IProps) => {

    const {aspectRatio, setAspectRatio, imageFileType, selectImagefiles, setImageFileType, setselectImagefiles} = props
                                    ...
                                    <div className="xl:col-span-4">
                                        <div className="card p-2">
                                            <div className="xl:col-span-12">
                                                <label className="mr-2 inline-block mb-2 text-base font-medium">Upload vendor logo image</label>
                                                <Dropzone
                                                    maxFiles={5}
                                                    multiple
                                                    onDrop={(acceptfiles: any) => {
                                                        handleAcceptImageFiles(acceptfiles);
                                                    }}>
                                                    {({ getRootProps }: any) => (
